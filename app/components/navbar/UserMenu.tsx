  ...
  return (
    <div className="relative">
      <div className="flex flex-row items-center gap-3">
        ...
        <div
          onClick={toggleOpen}
          className="rounded-full p-4 md:py-1 md:px-2 border-[1px] border-neutral-200 flex flex-row items-center gap-3 rounded-4 cursor-pointer hover:shadow-md transition "
        >
          <AiOutlineMenu />
